    ...
    class Package
      class TdRubygems < Chef::Provider::Package::Rubygems
        ...
        def initialize(new_resource, run_context = nil)
          Chef::Log.info("@new_resource : #{@new_resource} new_resource : #{new_resource}")
          super
          gem_binary_path = new_resource.gem_binary.empty? ? td_gem_binary_path : new_resource.gem_binary
          Chef::Log.info("gem binary path : #{gem_binary_path}")
          @new_resource.gem_binary gem_binary_path
          Chef::Log.info("@new_resource.plugin #{@new_resource.plugin} td_plugin_name #{td_plugin_name}")
